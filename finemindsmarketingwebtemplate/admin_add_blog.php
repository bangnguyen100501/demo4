                ...
                <form method="post">
                    <div class="box1 row">
                        <div class="col-9">
                            ...
                            <input type="text" name="txttitle" class="form-control" id="" >
                        </div>
                        <div class="col-3">
                    ...
                    <div class="box2">
                        ...
                        <textarea name="txtSContent" id="" class="form-control" cols="50" rows="4"></textarea>
                    </div>
                    <div class="box3">
                        <label for="" style="margin-top:20px">Long_Content</label>
                        <textarea name="txtLContent" class="form-control" id="" cols="50" rows="4"></textarea>
                    </div>
                    <input type="submit" class="btn btn-primary" value="Update" name="btn_submit" style="margin-top:20px">
                </form>
				<?php
                    if(isset($_POST['btn_submit'])){
                        $insert = $getdata -> in_blog($_POST['txttitle'], $_POST['txtdate'], $_POST['txtSContent'], $_POST['txtLContent']);

                        if($insert){
                            echo "<script>window.location.replace('admin_blog.php')</script>";
