<?php
    ...
    $select = $data -> select_all_contact();
                ...
                <table id="myTable" >
                    ...
                    ?>
                        ...
                        <td class="text-center">
                            ...
                            <a href="admin_sua_contact.php?edit=<?php  echo $se['ID_contact']?>" class="btn-edit" id ="btn_edit">
                            <ion-icon name="create-outline"></ion-icon></a>
                            <a href="admin_xoa_contact.php?delete=<?php  echo $se['ID_contact']?>"
