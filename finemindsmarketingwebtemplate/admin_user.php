            ...
            <div class="detail-table">
                ...
                <table id="myTable" >
                    ...
                    ?>
                        ...
                        <td><?php echo $row["name_regis"]; ?></td>
                        <td><?php echo $row["pass_regis"]; ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="admin_sua_register.php?edit=<?php  echo $row['ID_regis']?>" class="btn-edit" id ="btn_edit">
                            <ion-icon name="create-outline"></ion-icon></a>
                            <a href="admin_xoa_register.php?delete=<?php  echo $row['ID_regis']?>"
